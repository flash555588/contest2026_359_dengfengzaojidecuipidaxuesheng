...
esp_err_t claw_core_stop(claw_core_handle_t core, uint32_t timeout_ms)
{
    ...
    rc = claw_posix_task_wait(core->task_handle, timeout_ms ? timeout_ms : 5000);
    if (rc != 0) {
