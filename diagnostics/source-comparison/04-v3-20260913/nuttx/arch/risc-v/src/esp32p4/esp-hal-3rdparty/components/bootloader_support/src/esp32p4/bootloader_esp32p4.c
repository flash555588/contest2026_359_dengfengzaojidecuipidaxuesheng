...
#if !CONFIG_APP_BUILD_TYPE_PURE_RAM_APP && !defined(CONFIG_ESP32P4_SELECTS_REV_LESS_V3)
...
#if !CONFIG_APP_BUILD_TYPE_RAM && !defined(CONFIG_ESP32P4_SELECTS_REV_LESS_V3)
