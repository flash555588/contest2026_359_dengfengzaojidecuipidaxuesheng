...
const eyeL = ui.panel(322, 184, 54, 128, 27, 0x7ddfc3, 255);
const eyeR = ui.panel(W - 376, 184, 54, 128, 27, 0x7ddfc3, 255);
...
function renderFrame() {
  ...
  const eyeH = blinking ? 6 : Math.max(36, s[3] * 2);
  const eyeY = 170 + breath + oy;
  ui.setPos(eyeL, 322 + ox, eyeY); ui.setPos(eyeR, W - 376 + ox, eyeY);
  ui.setSize(eyeL, 54, eyeH); ui.setSize(eyeR, 54, eyeH);
}
