...
expected = '2159a0adca9a7e76680233064d907aa3676b6d10da12b1e35dae3901f7b65932'
...
rollback = workspace / '04-v3-20260913/wifi-dhcp-fix/nuttx.bin'
assert hashlib.sha256(rollback.read_bytes()).hexdigest() == '559e8f13dc4f1627048c6a5250383762d96262f3b892018382a1a68c60bca953'
