"""Build BLE changes in a private copy of the verified UI tree."""
...
delivery = workspace / '04-v3-20260913/ble-startup-fix'
base = workspace / '04-v3-20260913/ui-layout-fix'
old = Path('/tmp/v3-desktop-ui-layout-20260914')
root = Path('/tmp/v3-desktop-ble-startup-20260914')
...
print('BLE firmware SHA256:', hashlib.sha256((delivery / 'nuttx.bin').read_bytes()).hexdigest())
