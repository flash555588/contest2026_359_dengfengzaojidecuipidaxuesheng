...
/* ESP32-P4 GPIO matrix uses PAD names, not the C3/H2 U0TXD_OUT_IDX style. */

#  define U0TXD_OUT_IDX  UART0_TXD_PAD_OUT_IDX
#  define U0RXD_IN_IDX   UART0_RXD_PAD_IN_IDX
#  define U0RTS_OUT_IDX  UART0_RTS_PAD_OUT_IDX
#  define U0CTS_IN_IDX   UART0_CTS_PAD_IN_IDX
#  define U1TXD_OUT_IDX  UART1_TXD_PAD_OUT_IDX
#  define U1RXD_IN_IDX   UART1_RXD_PAD_IN_IDX
#  define U1RTS_OUT_IDX  UART1_RTS_PAD_OUT_IDX
#  define U1CTS_IN_IDX   UART1_CTS_PAD_IN_IDX
#endif
...
{
#ifdef CONFIG_ARCH_CHIP_ESP32P4
  /* P4 dropped PERIPH_UARTn_MODULE. Clock-gate via HP_SYS_CLKRST. */
