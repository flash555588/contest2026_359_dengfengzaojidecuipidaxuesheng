...
static volatile bool g_secondary_ready[CONFIG_SMP_NCPUS];
...
void IRAM_ATTR esp_smp_start_secondary(int cpu)
{
  DEBUGASSERT(cpu == 1);
...
void IRAM_ATTR esp_smp_secondary_c(void)
{
  ...
  __atomic_store_n(&g_secondary_ready[1], true, __ATOMIC_RELEASE);
  riscv_cpu_boot(1);
